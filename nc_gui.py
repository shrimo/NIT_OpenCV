...
class ExampleScene(EScene):
    ...
    def __init__(self, view):
        ...
        self.__control = None
        self.__nodes = {'Blur': BlurNode, 'OpenCV_Sift' : OCV_Sift_Node, 'OpenCV_Contour' : OCV_Contour_Node, 'Size': SizeNode, 'Read': ReadNode, 'Read2': ReadNode2, 'ReadStar': ReadStar,'ReadBuilding': ReadBuilding, 'Composite': CompositeNode, 'ColorSpace': ColorSpaceNode, 'Constant': ConstantNode}
        return
